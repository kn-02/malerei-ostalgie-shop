	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'vintage-flicker': 'vintage-flicker 3s ease-in-out infinite'
			},
			backgroundImage: {
				'ddr-pattern': `url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23dc2626' fill-opacity='0.1'%3E%3Cpath d='M10 0l10 10-10 10L0 10z'/%3E%3C/g%3E%3C/svg%3E")`,
